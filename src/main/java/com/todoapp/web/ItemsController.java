...
public class ItemsController {
    ...
    /**
     * Toggles the important value of a todo item.
     *
     * @param id the item identifier
     * @return the updated todo item
     */
    @PostMapping("/items/{itemId}/important")
    public ResponseEntity<?> toggleImportant(@PathVariable UUID itemId) {
        try {
            TodoItem toggledItem = itemService.toggleImportant(itemId);
            return ResponseEntity.ok(toggledItem);
